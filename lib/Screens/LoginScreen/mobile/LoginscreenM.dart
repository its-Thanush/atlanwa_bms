...
class _LoginscreenMState extends State<LoginscreenM> with TickerProviderStateMixin {
  ...
  void _showErrorNotification(String message) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        margin: EdgeInsets.all(SizeConfig.commonMargin! * 2),
  ...
  void _handleLogin() {
    ...
    if (username.isEmpty && password.isEmpty) {
      _showErrorNotification('Please enter username and password');
      return;
    }

    if (username.isEmpty) {
      _showErrorNotification('Please enter username');
      return;
    }

    if (password.isEmpty) {
      _showErrorNotification('Please enter password');
      return;
    }
    ...
    bloc.add(LoginSubmitEvent(username, password));
  }
